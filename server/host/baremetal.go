...
import (
	...
	"google3/third_party/platform_attestation/titan/measurements/measurements"
	...
	tpmquote "google3/third_party/golang/tpm_tools/quote/quote"
)
...
func VerifyAttestation(attestation *apb.HostAttestation, opts *VerifyOpts) (*apb.HostACOSState, error) {
	if opts == nil {
	...
	var quote *apb.TpmQuote_SignedQuote
...
func createPCRBank(pcrs *apb.TpmQuote_SignedQuote) (register.PCRBank, error) {
...
func validateTitanEndorsement(endorsement *apb.TpmAttestationEndorsement_TitanEndorsement, opts *titandice.ValidateScribeCertificateChainOptions) (crypto.PublicKey, error) {
	if endorsement == nil {
...
func toProtoQuote(quote *apb.TpmQuote_SignedQuote) *tpmpb.Quote {
	return &tpmpb.Quote{
...
func verifyEventLogs(tpmQuote *apb.TpmQuote, pcrBank register.PCRBank) (*apb.HostACOSState, error) {
