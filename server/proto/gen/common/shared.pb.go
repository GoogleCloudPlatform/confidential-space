...
const file_shared_proto_rawDesc = "" +
	"\n" +
	"\fshared.proto\x12\x06common*g\n" +
	"\x12SignatureAlgorithm\x12#\n" +
	"\x1fSIGNATURE_ALGORITHM_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11ECDSA_P256_SHA256\x10\x01\x12\x15\n" +
	"\x11RSASSA_PSS_SHA256\x10\x02BKZIgithub.com/GoogleCloudPlatform/confidential-space/server/proto/gen/commonb\x06proto3"
