...
export PRIMUS_SERVICE_ACCOUNT=${PRIMUS_SERVICE_ACCOUNT:-primus-sa}
export PRIMUS_WIP_PROVIDER=${PRIMUS_WIP_PROVIDER:-primus-attestation-verifier}
...
export SECUNDUS_SERVICE_ACCOUNT=${SECUNDUS_SERVICE_ACCOUNT:-secundus-sa}
export SECUNDUS_WIP_PROVIDER=${SECUNDUS_WIP_PROVIDER:-secundus-attestation-verifier}
...
export WORKLOAD_VM1=${WORKLOAD_VM1:-first-workload-cvm}
export WORKLOAD_VM2=${WORKLOAD_VM2:-second-workload-cvm}