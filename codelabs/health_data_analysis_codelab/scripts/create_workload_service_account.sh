...
echo "Creating workload service-account ${WORKLOAD_SERVICE_ACCOUNT} under project ${USLEEP_PROJECT_ID}..."
create_service_account ${WORKLOAD_SERVICE_ACCOUNT}

echo "Granting roles/iam.serviceAccountUser role to workload operator ..."
if ! gcloud iam service-accounts add-iam-policy-binding ${WORKLOAD_SERVICE_ACCOUNT}@${USLEEP_PROJECT_ID}.iam.gserviceaccount.com \
