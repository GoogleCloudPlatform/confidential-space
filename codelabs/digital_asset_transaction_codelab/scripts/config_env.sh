...
export PRIMUS_SERVICEACCOUNT=${PRIMUS_SERVICEACCOUNT:-${PRIMUS_PROJECT_ID}-mpc-sa}
export PRIMUS_WORKLOAD_IDENTITY_POOL=${PRIMUS_WORKLOAD_IDENTITY_POOL:-${PRIMUS_PROJECT_ID}-mpc-wip}
