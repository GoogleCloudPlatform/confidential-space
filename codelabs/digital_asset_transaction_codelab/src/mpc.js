/**
 * This file contains the logic to read the encrypted key shares from Cloud Storage buckets
 * and decrypt it using keys in KMS. It signs the transaction using decrypted key shares 
 * and submits the signed transaction to etherium node.
 */
