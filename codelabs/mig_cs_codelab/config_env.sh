...
export CURRENT_ARTIFACT_REPOSITORY=${CURRENT_ARTIFACT_REPOSITORY:-${CURRENT_PROJECT_ID:?Error: CURRENT_PROJECT_ID is not set. Please set it at the top of config_env.sh}-artifact-repo}
